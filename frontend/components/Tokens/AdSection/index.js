...
const AdSection = () => {
    ...
    return (
        <div className='container py-6 flex flex-col lg:items-center justify-center lg:flex-row gap-y-10 gap-x-20'>
            ...
            <div className=' px-6'>
                <a href='https://reefertoken.io/' rel="noreferrer" target="_blank" className='flex relative w-full justify-center container border dark:border-gray-700 border-gray-300 shadow-2xl shadow-gray-400 dark:shadow-gray-800 rounded-2xl bg-secondary dark:bg-[#252525]'>
                    <div className="absolute -inset-1 bg-gradient-to-r from-indigo-500 via-sky-400 to-indigo-700 rounded blur animate-pulse " />
